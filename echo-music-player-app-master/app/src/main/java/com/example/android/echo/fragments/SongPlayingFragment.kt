...
import com.example.android.echo.fragments.SongPlayingFragment.Statified.currentSongHelper
import com.example.android.echo.fragments.SongPlayingFragment.Statified.endTimeText
import com.example.android.echo.fragments.SongPlayingFragment.Statified.favoriteContent
            ...
            override fun run() {
                ...
                startTimeText?.setText(String.format("%d:%d",
                        ...
                        TimeUnit.MILLISECONDS.toSeconds(getcurrent?.toLong() as Long) -
                                TimeUnit.MINUTES.toSeconds(TimeUnit.MILLISECONDS.toMinutes(getcurrent?.toLong() as
                                Long))))
